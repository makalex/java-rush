...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = new File("src/main/resources/level20/lesson02/task04/t1.txt");
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            fWriter.write(staticString);
            fWriter.newLine();
            fWriter.write(String.valueOf(i));
            fWriter.newLine();
            fWriter.write(String.valueOf(j));
            fWriter.newLine();
            fWriter.close();
        }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            staticString = fReader.readLine();
            i = Integer.parseInt(fReader.readLine());
            j = Integer.parseInt(fReader.readLine());
            fReader.close();
        }
    }
}
